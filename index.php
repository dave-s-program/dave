  ...
  <body>
    ...
    <div class="site-wrap">
      ...
      <div class="offcanvas_menu" id="offcanvas_menu">
        <ul class="mb-5">
          <li class="active"><a href="index.php">Bio</a></li>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
      ...
      <main>
        <h1 class="mb-0">Hi, I'm Dave F. Malhin</h1>
        <div class="mb-5">
        <p class="lead mb-3">Web Developer &amp; Desktop Support Engineer</p>
        <p>To obtain a position in your company that would fit on my qualifications as a BS
            Information Technology graduate, in which I will gain valuable experience and to offer my
            service with determination and commitment to be an asset to your company throughout the
            duration of my employment period.</p>
        </div>
